            ...
            <table className="w-full text-left text-sm">
              ...
              <tbody className="divide-y divide-slate-700">
                {filteredClients.map((client) => {
                  ...
                  const platformColor =
                    PLATFORMS.find((p) => p.id === client.platform)?.color ||
                    "bg-slate-600";
                      ...
                      <td className="px-4 py-3 align-middle text-right">
                        <div className="flex items-center justify-end gap-1">
                          ...
                          <button
                            ...
                            className="p-1.5 text-emerald-400 bg-emerald-900/20 rounded-lg hover:bg-emerald-900/40 transition-colors"
                          >
              ...
              <div className="flex items-center gap-4">
                <div
                  className={`w-12 h-12 rounded-xl flex items-center justify-center shadow-lg ${
                    PLATFORMS.find((p) => p.id === viewDetailsClient.platform)
                      ?.color || "bg-slate-700"
                  }`}
                >
                  <Monitor className="w-6 h-6 text-white" />
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div
                  ...
                  onClick={() => openWhatsApp(viewDetailsClient.contact)}
                >
